...
-- Recreate get_admin_users_data function with proper permissions
...
-- Recreate get_school_users_data function with proper permissions
...
-- Recreate get_schools_data function with proper permissions
