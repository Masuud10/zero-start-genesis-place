...
-- Check foreign key constraints on grades table
SELECT 
...
-- Check specifically for student_id constraints
SELECT 
    conname as constraint_name,
...
-- 1. Only one foreign key constraint for grades.student_id (fk_grades_student_id)
-- 2. No duplicate constraints with names like grades_student_id_fkey
-- 3. PostgREST queries with students embedding should work correctly
-- 4. No more PGRST201 errors

-- ============================================================================
-- TESTING
-- ============================================================================
-- To test the fix:
-- 1. Try a query like: SELECT * FROM grades?select=*,students(*)
-- 2. Verify no PGRST201 error occurs
-- 3. Check that the relationship works correctly 