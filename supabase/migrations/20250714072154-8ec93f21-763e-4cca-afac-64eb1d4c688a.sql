-- Fix the ambiguous registration_number column reference in create_comprehensive_school function
...
BEGIN
  ...
  IF create_comprehensive_school.registration_number IS NOT NULL AND EXISTS (
  ...
  -- Create the school with only existing columns
