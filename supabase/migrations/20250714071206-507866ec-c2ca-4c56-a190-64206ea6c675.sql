-- Fix the create_enhanced_school and create_comprehensive_school functions
-- Remove all references to curriculum_type column which no longer exists

-- First function: create_enhanced_school (the one from line 1 of the query results)
...
-- Update create_comprehensive_school function to remove curriculum_type references
