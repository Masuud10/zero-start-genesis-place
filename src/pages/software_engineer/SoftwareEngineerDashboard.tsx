...
const SoftwareEngineerDashboard = () => {
  ...
  const systemStats = {
    overallStatus: systemHealth?.overallStatus || "healthy",
    cpuUsage: systemHealth?.metrics?.cpu || 0,
    memoryUsage: systemHealth?.metrics?.memory || 0,
    diskUsage: systemHealth?.metrics?.disk || 0,
    errorCount: systemHealth?.errorLogs?.length || 0,
    slowQueries: systemHealth?.queryPerformance?.length || 0,
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <EnhancedCard variant="elevated" animation="fade" className="p-6">
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                ...
                {(!systemHealth?.queryPerformance ||
                  systemHealth.queryPerformance.length === 0) && (
        ...
        <TabsContent value="logs" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <EnhancedCard variant="elevated" animation="fade" className="p-6">
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {systemHealth?.errorLogs?.slice(0, 10).map((log, index) => (
                  <div key={index} className="p-3 border rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium">
                        {log.error_type}
            ...
            <EnhancedCard variant="elevated" animation="fade" className="p-6">
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                ...
                <div className="p-3 border rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium">POST /api/users</span>
                    <Badge className="bg-green-100 text-green-800 text-xs">
                      201
                    </Badge>
                  </div>
