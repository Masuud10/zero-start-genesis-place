...
// Import SupportTicket type from DashboardContext
type SupportTicket = {
  id: number;
  school_id: string;
  submitted_by: string;
...
const SupportHrDashboard = () => {
  const { supportTickets, loadingTickets, errorTickets, refreshTickets } =
    useDashboard();
    ...
    return (
      <div className="space-y-6">
        <Alert variant="destructive">
          <AlertDescription>
            Error loading dashboard: {errorTickets}
          </AlertDescription>
        </Alert>
      </div>
    );
          ...
          <TabsContent value="client-relations" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                              {ticket.schools.name || "Unknown School"} •{" "}
                              {ticket.submitted_by_user?.name || "Unknown User"}
                            </p>
                          </div>
                          <div className="flex items-center space-x-2">
                            <Badge
              ...
              <EnhancedCard variant="elevated" animation="fade" className="p-6">
                ...
                <PieChart
                  data={[
                    { label: "Healthy", value: 65, color: "#10b981" },
                    { label: "Warning", value: 25, color: "#f59e0b" },
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {selectedTicket.schools.name || "Unknown"}
                  </p>
                </div>
                <div>
                  <span className="text-sm font-medium">Submitted by:</span>
                  <p className="text-sm text-muted-foreground">
                    {selectedTicket.submitted_by_user?.name || "Unknown"}
                  </p>
                </div>
                <div>
