    ...
    >
      ...
      <div className="text-center border-b-2 border-blue-600 pb-6 mb-8 relative z-10">
        <div className="flex items-center justify-center gap-6 mb-4">
          ...
          <div className="text-center">
            ...
            {school?.motto && (
              <p className="text-lg italic text-blue-700 mb-1">
                "{school.motto}"
              </p>
            )}
            {school?.slogan && (
      ...
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border-l-4 border-blue-600">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-xl font-semibold text-blue-900">
                {studentPerformance.class_position
                  ? `${studentPerformance.class_position}`
                  : "Not Available"}
              </p>
            </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg border-l-4 border-green-600">
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            <div className="text-center p-4 bg-white rounded-lg shadow-sm">
              ...
              <p className="text-3xl font-bold text-green-700">
                {studentPerformance.total_marks || 0}/
                {studentPerformance.possible_marks || 0}
              </p>
            </div>
            <div className="text-center p-4 bg-white rounded-lg shadow-sm">
          ...
          {/* Subject Performance */}
          {studentPerformance.subjects_performance &&
            studentPerformance.subjects_performance.length > 0 && (
              <div>
                <h4 className="text-lg font-semibold text-green-800 mb-3 text-center">
                  Subject Performance
                </h4>
                <div className="grid grid-cols-2 gap-3 text-sm">
                  {studentPerformance.subjects_performance.map(
                    (subject, index) => (
                      <div
                        key={index}
      ...
      <div className="mt-12 border-t-2 border-blue-600 pt-8">
        ...
        <div className="text-right mt-8">
          <p className="text-xs text-gray-500">
            Powered by{" "}
            <span className="font-semibold text-blue-600">EduFam</span>
          </p>
          <p className="text-xs text-gray-400">www.edufam.org</p>
        </div>
      </div>
