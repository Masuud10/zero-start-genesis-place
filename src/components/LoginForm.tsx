  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        console.log(
          "✅ LoginForm: Authentication successful for user:",
          data.user.email
        );
        ...
        if (showSignUp) {
          ...
          toast({
            title: "Welcome back!",
            description:
              "Successfully logged into Elimisha school management system.",
          });
        }
      }
    } catch (error: any) {
      console.error(
        "🔴 LoginForm: Unexpected error during authentication:",
        error
      );
