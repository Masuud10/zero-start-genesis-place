...
import { Wrench, AlertTriangle, Clock, Download, Database, Shield } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage system maintenance mode and backup operations</p>
        </div>
        {settings.enabled && (
          ...
          {settings.enabled && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                ...
                <br />
                All users except EduFam Admins are blocked from accessing the platform.
              </AlertDescription>
            </Alert>
          )}
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-600">
            Create and download system backups to ensure data safety and recovery capabilities.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="p-4 border-2 border-dashed border-blue-300 bg-blue-50">
              <div className="text-center space-y-3">
                ...
                <div>
                  <h3 className="font-medium text-blue-900">Full Database Backup</h3>
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Backup Schedule:</strong> Automated backups are performed daily at 2:00 AM UTC. 
              Manual backups can be triggered anytime using the buttons above.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
