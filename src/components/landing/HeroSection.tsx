      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-l from-purple-100/20 via-transparent to-yellow-100/20 animate-pulse" style={{ animationDelay: '1s' }}></div>
          </div>
        </div>
      </div>
