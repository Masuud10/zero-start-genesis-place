      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Every school is unique. Let's create a plan that fits your specific needs, 
            student count, and budget. Get personalized pricing designed for Kenyan schools.
          </p>
        </div>
            ...
            <CardContent className="px-8 pb-8">
              <div className="space-y-6 mb-8">
                <div className="bg-blue-50 rounded-lg p-6">
                  <h3 className="font-semibold text-gray-900 mb-4">What's Included in Your Custom Plan:</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3">
                      <Check className="w-5 h-5 text-green-600" />
                      <span className="text-gray-700">Unlimited student records</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Check className="w-5 h-5 text-green-600" />
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-gray-600 mb-6">
            Join over 1,000+ schools across Kenya already using EduFam
          </p>
