  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response?.success && response?.school_id) {
        toast({
          title: "Success!",
          description: response.message || "School registered successfully in the EduFam network",
        });
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Create a new school profile with essential information. Only required fields are marked with *.
          </p>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Essential School Information</h3>
          ...
          {/* Optional Branding */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">School Branding (Optional)</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Administrative Contacts (Optional)</h3>
            <p className="text-sm text-muted-foreground">
              These users will be automatically created with access to the school's management system.
            </p>
