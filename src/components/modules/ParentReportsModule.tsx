...
const ParentReportsModule: React.FC = () => {
    ...
    if (loading) return <div>Loading report information...</div>;
        ...
        return (
             <Card>
                <CardContent className="pt-6">
                    <p>No report information available for your child(ren).</p>
                </CardContent>
            </Card>
        );
    }
    ...
    return (
        <div className="space-y-6">
            <h3 className="text-2xl font-bold mb-2">Download Child Reports</h3>
                ...
                <Card key={child.studentId}>
                    ...
                    <CardContent>
                        {child.classId ? (
                            ...
                            <p>This student is not currently assigned to a class, so reports cannot be generated.</p>
                        )}
                    </CardContent>
                </Card>
            ))}
