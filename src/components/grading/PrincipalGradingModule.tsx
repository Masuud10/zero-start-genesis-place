...
const PrincipalGradingModule = () => {
  ...
  const fetchGrades = async () => {
    ...
    try {
      ...
      const formattedGrades: GradeRecord[] =
        data?.map((grade: any) => ({
          id: grade.id,
  ...
  const handleOverride = async () => {
    ...
    try {
      ...
      if (
        isNaN(overrideValue) ||
        overrideValue < 0 ||
        overrideValue > selectedGrade.max_score
      ) {
        toast({
          title: "Error",
  ...
  return (
    <div className="space-y-6">
                  ...
                  {grades.map((grade) => (
                    <TableRow key={grade.id}>
                        ...
                        <div className="flex flex-col">
                          ...
                          {grade.overridden_grade && (
                            <span className="text-orange-600 font-medium">
                              {grade.overridden_grade}/{grade.max_score}{" "}
                              (Override)
                            </span>
                          )}
                      ...
                      <TableCell>
                        {getStatusBadge(
                          grade.status,
                          grade.approved_by_principal,
                          grade.released_to_parents
                        )}
                      </TableCell>
                        ...
                        <div className="flex gap-1">
                          ...
                          {grade.approved_by_principal &&
                            !grade.released_to_parents && (
                              <Button
                                size="sm"
                                onClick={() => handleRelease([grade.id])}
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              setOverrideScore(
                                grade.overridden_grade?.toString() ||
            ...
            {selectedGrade && (
              <>
                <div className="bg-gray-50 p-3 rounded-lg">
                  <p>
                    <strong>Student:</strong> {selectedGrade.student_name}
                  </p>
                  <p>
                    <strong>Subject:</strong> {selectedGrade.subject_name}
                  </p>
                  <p>
      ...
      {selectedClass && selectedTerm && selectedExamType && (
        <Dialog open={true} onOpenChange={() => setSelectedClass("")}>
