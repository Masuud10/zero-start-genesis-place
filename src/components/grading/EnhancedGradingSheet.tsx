    ...
    <div className="w-full h-[600px] overflow-auto border rounded-lg bg-white">
      ...
      <div className="bg-gray-50 border-b p-3 sticky top-0 z-30">
        <div className="flex items-center gap-4 text-sm font-medium text-gray-700">
          ...
          <span>•</span>
          <span>Curriculum: <strong>{curriculumType.toUpperCase()}</strong></span>
          {isReadOnly && (
          ...
          <thead className="bg-gray-100 sticky top-[60px] z-20">
            <tr>
              ...
              {subjects.map((subject) => (
                <th key={subject.id} className="border border-gray-300 p-3 text-center font-semibold min-w-[180px]">
              ...
              <th className="border border-gray-300 p-3 text-center font-semibold min-w-[220px] bg-blue-50">
                ...
                <div className="text-xs text-blue-600 mt-1">Total | Average | Position | Grade</div>
              </th>
            </tr>
          </thead>
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className={`h-8 text-center text-sm font-medium transition-colors ${
                              ...
                              gradeValue?.score ? 'bg-green-50 border-green-200' : ''
                            }`}
                          />
                            ...
                            <div className="flex items-center justify-center">
                              <Badge 
                                ...
                                className={`text-xs px-2 py-0 ${
                                  gradeValue.letter_grade === 'A+' || gradeValue.letter_grade === 'A' ? 'border-green-500 text-green-700' :
                                  gradeValue.letter_grade === 'B+' || gradeValue.letter_grade === 'B' ? 'border-blue-500 text-blue-700' :
                                  gradeValue.letter_grade === 'C+' || gradeValue.letter_grade === 'C' ? 'border-yellow-500 text-yellow-700' :
                                  gradeValue.letter_grade === 'D+' || gradeValue.letter_grade === 'D' ? 'border-orange-500 text-orange-700' :
                    ...
                    {studentTotal && studentTotal.subjectCount > 0 ? (
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-center">
                          ...
                          >
                            Position: {studentTotal.position > 0 ? studentTotal.position : 'N/A'}
                          </Badge>
                        </div>
                        <div className="flex justify-center">
                          <Badge 
                            ...
                            className={`text-xs px-2 py-1 ${
                              studentTotal.letterGrade === 'A+' || studentTotal.letterGrade === 'A' ? 'border-green-500 text-green-700 bg-green-50' :
                              studentTotal.letterGrade === 'B+' || studentTotal.letterGrade === 'B' ? 'border-blue-500 text-blue-700 bg-blue-50' :
                              studentTotal.letterGrade === 'C+' || studentTotal.letterGrade === 'C' ? 'border-yellow-500 text-yellow-700 bg-yellow-50' :
                              studentTotal.letterGrade === 'D+' || studentTotal.letterGrade === 'D' ? 'border-orange-500 text-orange-700 bg-orange-50' :
                      ...
                      <div className="text-xs text-gray-500 italic">No grades entered</div>
                    )}
                  </td>
                </tr>
              );
